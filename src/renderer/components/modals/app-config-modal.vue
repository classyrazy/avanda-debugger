<template>
    <div class="p-6">
        <div class="flex justify-between my-4">
            ...
            <close-icon class="cursor-pointer" @click="$emit('close', projectDetails?.baseurl)"></close-icon>
        </div>
        <div class="my-4">
            ...
            <input placeholder="App name" id="app-name"
                ...
                type="text" v-model="projectDetails.name" disabled>
        </div>
        <div class="my-4">
            ...
            <input placeholder="Base Url" id="base-url"
                class="text-sm rounded-lg bg-transparent outline-none inline-block appearance-none border w-full py-3 px-2 text-md text-gray-400 focus:text-black"
                type="text" v-model="projectDetails.baseurl">
        </div>
        ...
        <div class="body-table border-t mt-4 ">
            ...
            <div class="relative border-t last:border-b" v-for="(varForm, idx) in projectDetails?.environs" :key="idx">
                <ul class="grid grid-cols-2 justify-around gap-4 border-r border-l mx-8 ml-10 px-2">
                    <li class="border-r flex items-center">
                        <input placeholder="key"
                            ...
                            type="text" v-model="projectDetails.environs[idx].key">
                    ...
                    <li class="flex items-center">
                        <textarea placeholder="value"
                            ...
                            v-model="projectDetails.environs[idx].value"></textarea>
                    </li>
                </ul>
            </div>
